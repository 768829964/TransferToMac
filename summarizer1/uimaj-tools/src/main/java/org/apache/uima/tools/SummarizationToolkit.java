...
import org.apache.uima.tools.cpm.CpmFrame;
 ...
 *
 */
public class SummarizationToolkit extends JFrame {
	 ...
	 */
	public SummarizationToolkit() {
		super("Summarization Toolkit");
		...
		SpringUtilities.makeCompactGrid(controlPanel, 1, 2, // rows, cols
				4, 4, // initX, initY
				4, 4); // xPad, yPad
		...
		helpMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				JOptionPane.showMessageDialog(SummarizationToolkit.this, HELP_MESSAGE,
	...
	public static void main(String[] args) {
		final SummarizationToolkit frame = new SummarizationToolkit();
	...
	public void displayError(String aErrorString) {
		...
		JOptionPane.showMessageDialog(SummarizationToolkit.this, buf.toString(), "Error",
